...
- [📖 Hello Rails back-end ](#-hello-rails-react-)
...
Hello Rails back-end is a project setup as one app with rails and used as an api end point.
...
```sh
 rails s
```
[here is link to front_end Pull request](https://github.com/bernabasy/hello-react-front-end/pull/1)
...
Feel free to check the [issues page](https://github.com/bernabasy/hello-rails-back-end1/issues).
